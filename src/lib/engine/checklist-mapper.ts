...
const checklistDefinitions: Record<string, ChecklistDefinition> = {
  ...
  // ── Traffic ──
  traffic_check_challan: {
    title: { en: "Check your e-challan status online", hi: "अपना ई-चालान स्थिति ऑनलाइन जांचें" },
    description: { en: "Visit echallan.parivahan.gov.in or your state traffic police website. Enter your vehicle number to see all pending challans.", hi: "echallan.parivahan.gov.in या अपने राज्य ट्रैफिक पुलिस वेबसाइट पर जाएं। सभी लंबित चालान देखने के लिए वाहन नंबर दर्ज करें।" },
    urgency: "medium",
    applicableAct: "Motor Vehicles Act, 1988",
    documentType: null,
  },
  traffic_dispute_challan: {
    title: { en: "Dispute the challan in Virtual Traffic Court", hi: "वर्चुअल ट्रैफिक कोर्ट में चालान का विवाद करें" },
    description: { en: "You can dispute an incorrect challan through Virtual Traffic Courts or the Transport Commissioner's office. File within 60 days.", hi: "वर्चुअल ट्रैफिक कोर्ट या परिवहन आयुक्त कार्यालय में गलत चालान का विवाद कर सकते हैं। 60 दिनों में दर्ज करें।" },
    urgency: "medium",
    applicableAct: "Motor Vehicles (Amendment) Act, 2019",
    documentType: null,
  },
  traffic_pay_challan: {
    title: { en: "Pay your traffic challan online", hi: "ट्रैफिक चालान ऑनलाइन भुगतान करें" },
    description: { en: "Pay at echallan.parivahan.gov.in. Late payment may attract additional penalties.", hi: "echallan.parivahan.gov.in पर भुगतान करें। देर से भुगतान पर अतिरिक्त जुर्माना लग सकता है।" },
    urgency: "low",
    applicableAct: "Motor Vehicles Act, 1988",
    documentType: null,
  },
  traffic_accident_steps: {
    title: { en: "Follow accident procedure — file FIR + get medical report", hi: "दुर्घटना प्रक्रिया का पालन करें — FIR + मेडिकल रिपोर्ट" },
    description: { en: "Get injured persons to hospital first. Then file FIR at nearest police station. Get a medical report. Take photos of the scene and vehicles.", hi: "पहले घायलों को अस्पताल ले जाएं। फिर निकटतम पुलिस स्टेशन में FIR दर्ज करें। मेडिकल रिपोर्ट लें। घटनास्थल और वाहनों की फोटो लें।" },
    urgency: "high",
    applicableAct: "BNSS Section 173 / Motor Vehicles Act Section 134",
    documentType: null,
  },
  traffic_mact_claim: {
    title: { en: "File MACT claim for accident compensation", hi: "दुर्घटना मुआवज़े के लिए MACT दावा दर्ज करें" },
    description: { en: "File a claim at the Motor Accidents Claims Tribunal (MACT) for compensation. No court fees. You can claim medical costs, loss of income, and suffering.", hi: "MACT में मुआवज़े का दावा दर्ज करें। कोई अदालत शुल्क नहीं। चिकित्सा खर्च, आय हानि, और पीड़ा का दावा कर सकते हैं।" },
    urgency: "high",
    applicableAct: "Motor Vehicles Act Section 166",
    documentType: null,
  },
  traffic_file_fir: {
    title: { en: "File FIR for the accident", hi: "दुर्घटना के लिए FIR दर्ज करें" },
    description: { en: "FIR is essential for insurance claims and MACT. Police must file it — if they refuse, complain to SP.", hi: "FIR बीमा दावों और MACT के लिए आवश्यक है। पुलिस को दर्ज करना अनिवार्य है।" },
    urgency: "high",
    applicableAct: "BNSS Section 173",
    documentType: null,
  },
  traffic_license_recovery: {
    title: { en: "Apply to recover your seized license", hi: "ज़ब्त लाइसेंस वापस पाने के लिए आवेदन करें" },
    description: { en: "Apply to the Transport Commissioner within 30 days. If seized illegally, file a complaint. License can only be seized under specific sections of MV Act.", hi: "30 दिनों के भीतर परिवहन आयुक्त को आवेदन करें। गैरकानूनी ज़ब्ती पर शिकायत दर्ज करें।" },
    urgency: "medium",
    applicableAct: "Motor Vehicles Act Section 206",
    documentType: null,
  },
  traffic_anti_corruption: {
    title: { en: "Report traffic police bribery", hi: "ट्रैफिक पुलिस रिश्वतखोरी की रिपोर्ट करें" },
    description: { en: "Record video if safe. File complaint on your state's anti-corruption portal or call CVC 1031. You can also complain to the Traffic DCP.", hi: "सुरक्षित हो तो वीडियो रिकॉर्ड करें। राज्य के भ्रष्टाचार विरोधी पोर्टल पर शिकायत करें या CVC 1031 पर कॉल करें।" },
    urgency: "medium",
    applicableAct: "Prevention of Corruption Act, 1988",
    documentType: null,
  },
  traffic_get_digilocker: {
    title: { en: "Set up DigiLocker for driving documents", hi: "ड्राइविंग दस्तावेज़ों के लिए DigiLocker सेट करें" },
    description: { en: "Download DigiLocker app and link your driving license + vehicle RC. Digital copies are legally valid — police cannot fine you for not carrying physical copies.", hi: "DigiLocker ऐप डाउनलोड करें और ड्राइविंग लाइसेंस + वाहन RC लिंक करें। डिजिटल प्रतियां कानूनी रूप से मान्य हैं।" },
    urgency: "low",
    applicableAct: "Motor Vehicles (Amendment) Act, 2019",
    documentType: null,
  },
  traffic_no_insurance: {
    title: { en: "Driving without insurance is a serious offence", hi: "बिना बीमा के वाहन चलाना गंभीर अपराध है" },
    description: { en: "Third-party insurance is mandatory. Fine: ₹2,000 first offence, ₹4,000 repeat. Get insurance immediately to avoid liability in accidents.", hi: "तृतीय-पक्ष बीमा अनिवार्य है। जुर्माना: ₹2,000 पहली बार, ₹4,000 दोबारा। दुर्घटनाओं में देनदारी से बचने के लिए तुरंत बीमा करवाएं।" },
    urgency: "high",
    applicableAct: "Motor Vehicles Act Section 146",
    documentType: null,
  },
  traffic_drink_driving: {
    title: { en: "Drink driving is a criminal offence", hi: "नशे में वाहन चलाना आपराधिक अपराध है" },
    description: { en: "Blood alcohol limit: 30mg/100ml. First offence: up to 6 months jail + ₹10,000 fine. Second offence: up to 2 years + ₹15,000. Consult a lawyer immediately.", hi: "रक्त में शराब सीमा: 30mg/100ml। पहला अपराध: 6 माह जेल + ₹10,000 जुर्माना। तुरंत वकील से सलाह लें।" },
    urgency: "high",
    applicableAct: "Motor Vehicles Act Section 185 / BNS Section 281",
    documentType: null,
  },

  // ── Senior Citizen ──
  senior_maintenance_tribunal: {
    title: { en: "Apply to Senior Citizen Maintenance Tribunal", hi: "वरिष्ठ नागरिक भरण-पोषण न्यायाधिकरण में आवेदन करें" },
    description: { en: "File application at the District Magistrate's office. The tribunal can order children to pay up to ₹10,000/month maintenance. Decision within 90 days.", hi: "जिला मजिस्ट्रेट कार्यालय में आवेदन दर्ज करें। ट्रिब्यूनल बच्चों को ₹10,000/माह तक भरण-पोषण का आदेश दे सकता है। 90 दिनों में निर्णय।" },
    urgency: "high",
    applicableAct: "Maintenance and Welfare of Parents and Senior Citizens Act, 2007",
    documentType: "application",
  },
  senior_file_case: {
    title: { en: "File case for maintenance under Section 125 CrPC", hi: "CrPC धारा 125 के तहत भरण-पोषण का मामला दर्ज करें" },
    description: { en: "Parents unable to maintain themselves can claim maintenance from children. Apply at Maintenance Tribunal or Family Court.", hi: "अपना भरण-पोषण करने में असमर्थ माता-पिता बच्चों से भरण-पोषण का दावा कर सकते हैं।" },
    urgency: "high",
    applicableAct: "CrPC Section 125 / BNSS Section 144",
    documentType: null,
  },
  senior_revoke_transfer: {
    title: { en: "Revoke property transfer if children neglect you", hi: "बच्चे उपेक्षा करें तो संपत्ति हस्तांतरण रद्द करें" },
    description: { en: "Under the Senior Citizens Act, if you transferred property to children and they neglect you, the Tribunal can declare the transfer void.", hi: "वरिष्ठ नागरिक अधिनियम के तहत, यदि आपने बच्चों को संपत्ति हस्तांतरित की और वे उपेक्षा करते हैं, तो ट्रिब्यूनल हस्तांतरण रद्द कर सकता है।" },
    urgency: "high",
    applicableAct: "Maintenance and Welfare of Parents and Senior Citizens Act, 2007 Section 23",
    documentType: null,
  },
  senior_police_complaint: {
    title: { en: "File police complaint for elder abuse", hi: "वृद्ध शोषण के लिए पुलिस शिकायत दर्ज करें" },
    description: { en: "Elder abuse is a cognizable offence. File FIR at the police station. If police refuse, complain to SP or call Elder Line 14567.", hi: "वृद्ध शोषण संज्ञेय अपराध है। पुलिस स्टेशन में FIR दर्ज करें। पुलिस मना करे तो SP को शिकायत करें या एल्डर लाइन 14567 पर कॉल करें।" },
    urgency: "high",
    applicableAct: "BNS Section 360 (Abandonment of Person) / Senior Citizens Act 2007",
    documentType: null,
  },
  senior_helpline: {
    title: { en: "Call Elder Line 14567 for help", hi: "सहायता के लिए एल्डर लाइन 14567 पर कॉल करें" },
    description: { en: "14567 is the national helpline for senior citizens. Available 8am-8pm. Provides emotional support, pension help, abuse reporting, and legal aid referrals.", hi: "14567 वरिष्ठ नागरिकों के लिए राष्ट्रीय हेल्पलाइन है। सुबह 8 से रात 8 बजे तक उपलब्ध।" },
    urgency: "medium",
    applicableAct: "Senior Citizens Act 2007",
    documentType: null,
  },
  senior_ayushman: {
    title: { en: "Check Ayushman Bharat eligibility", hi: "आयुष्मान भारत पात्रता जांचें" },
    description: { en: "Check at mera.pmjay.gov.in. If eligible, you get ₹5 lakh/year free health coverage at empaneled hospitals.", hi: "mera.pmjay.gov.in पर जांचें। पात्र होने पर, सूचीबद्ध अस्पतालों में ₹5 लाख/वर्ष मुफ्त स्वास्थ्य कवरेज मिलता है।" },
    urgency: "medium",
    applicableAct: "Ayushman Bharat PM-JAY",
    documentType: null,
  },
  senior_ayushman_70: {
    title: { en: "Ayushman Bharat 70+ — free health coverage for all seniors above 70", hi: "आयुष्मान भारत 70+ — 70 से ऊपर सभी वरिष्ठ नागरिकों के लिए मुफ्त स्वास्थ्य कवर" },
    description: { en: "From 2025, all citizens aged 70+ get ₹5 lakh/year health coverage regardless of income. Register at mera.pmjay.gov.in with Aadhaar.", hi: "2025 से, 70+ आयु के सभी नागरिकों को आय की परवाह किए बिना ₹5 लाख/वर्ष स्वास्थ्य कवर मिलता है। आधार से mera.pmjay.gov.in पर पंजीकरण करें।" },
    urgency: "medium",
    applicableAct: "Ayushman Bharat PM-JAY 70+ Extension (2025)",
    documentType: null,
  },
  senior_pension: {
    title: { en: "Apply for Old Age Pension (IGNOAPS)", hi: "वृद्धावस्था पेंशन (IGNOAPS) के लिए आवेदन करें" },
    description: { en: "BPL citizens aged 60+ can get ₹300/month (₹500 for 80+) under IGNOAPS. Apply at Block/District Social Welfare Office.", hi: "60+ आयु के BPL नागरिक IGNOAPS के तहत ₹300/माह (80+ के लिए ₹500) पा सकते हैं।" },
    urgency: "medium",
    applicableAct: "National Social Assistance Programme (NSAP)",
    documentType: null,
  },
  senior_make_will: {
    title: { en: "Make a will to protect your assets", hi: "अपनी संपत्ति की सुरक्षा के लिए वसीयत बनाएं" },
    description: { en: "Without a will, your property will be distributed by succession law — which may not match your wishes. Use NyayCheck's will template.", hi: "वसीयत के बिना, आपकी संपत्ति उत्तराधिकार कानून से बंटेगी — जो आपकी इच्छाओं से मेल नहीं खा सकती। NyayCheck का वसीयत टेम्पलेट उपयोग करें।" },
    urgency: "medium",
    applicableAct: "Indian Succession Act, 1925",
    documentType: null,
  },
  ...
  // ── Domestic Help ──
  dh_minimum_wages: {
    title: { en: "Know the minimum wage for domestic workers", hi: "घरेलू कामगारों का न्यूनतम वेतन जानें" },
    description: { en: "Domestic workers are covered under the Minimum Wages Act in most states. Check your state's notification — typically ₹8,000-₹15,000/month. Underpayment is a criminal offence.", hi: "अधिकांश राज्यों में घरेलू कामगार न्यूनतम मज़दूरी अधिनियम के अंतर्गत आते हैं। अपने राज्य की अधिसूचना जांचें — आमतौर पर ₹8,000-₹15,000/माह।" },
    urgency: "medium",
    applicableAct: "Minimum Wages Act, 1948",
    documentType: null,
  },
  dh_file_complaint: {
    title: { en: "File complaint with Labour Commissioner", hi: "श्रम आयुक्त से शिकायत करें" },
    description: { en: "Visit the Labour Commissioner's office and file a complaint for unpaid wages. It's free and you don't need a lawyer.", hi: "श्रम आयुक्त कार्यालय जाएं और बकाया मज़दूरी की शिकायत दर्ज करें। यह मुफ्त है और वकील की ज़रूरत नहीं।" },
    urgency: "high",
    applicableAct: "Payment of Wages Act, 1936 / Minimum Wages Act, 1948",
    documentType: null,
  },
  dh_posh_complaint: {
    title: { en: "Report workplace sexual harassment", hi: "कार्यस्थल पर यौन उत्पीड़न की रिपोर्ट करें" },
    description: { en: "Sexual harassment at any workplace — including homes — is a crime. File complaint with the Local Complaints Committee (LCC) at the District Officer or call 181.", hi: "किसी भी कार्यस्थल पर — घर सहित — यौन उत्पीड़न अपराध है। जिला अधिकारी के पास स्थानीय शिकायत समिति (LCC) में शिकायत करें या 181 पर कॉल करें।" },
    urgency: "high",
    applicableAct: "POSH Act, 2013",
    documentType: null,
  },
  dh_police_complaint: {
    title: { en: "File police complaint for abuse", hi: "दुर्व्यवहार के लिए पुलिस शिकायत दर्ज करें" },
    description: { en: "Physical abuse, confinement, or threats are criminal offences. File FIR at the police station. Call 100 if in immediate danger.", hi: "शारीरिक दुर्व्यवहार, कैद, या धमकी आपराधिक अपराध है। पुलिस स्टेशन में FIR दर्ज करें। तत्काल खतरे में 100 पर कॉल करें।" },
    urgency: "high",
    applicableAct: "BNS Sections 115-118 (Hurt) / BNSS Section 173",
    documentType: null,
  },
  dh_get_agreement: {
    title: { en: "Get a written work agreement", hi: "लिखित कार्य अनुबंध प्राप्त करें" },
    description: { en: "A written agreement protects both worker and employer. Include: working hours, wages, holidays, notice period. Use NyayCheck's template.", hi: "लिखित अनुबंध कामगार और नियोक्ता दोनों की रक्षा करता है। शामिल करें: कार्य घंटे, मज़दूरी, छुट्टियां, नोटिस अवधि।" },
    urgency: "medium",
    applicableAct: "Indian Contract Act, 1872",
    documentType: null,
  },
  dh_register_eshram: {
    title: { en: "Register on e-Shram portal for benefits", hi: "लाभ के लिए ई-श्रम पोर्टल पर पंजीकरण करें" },
    description: { en: "Register at eshram.gov.in with Aadhaar. You get: ₹2 lakh accidental insurance, access to government schemes, and a UAN number.", hi: "आधार से eshram.gov.in पर पंजीकरण करें। आपको मिलता है: ₹2 लाख दुर्घटना बीमा, सरकारी योजनाओं तक पहुंच, और UAN नंबर।" },
    urgency: "medium",
    applicableAct: "Unorganised Workers Social Security Act, 2008",
    documentType: null,
  },
};
